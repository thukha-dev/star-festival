const socialLinks = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/thu.kha.aung.105664",
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/kaka_thukha/",
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden className="h-5 w-5 fill-current">
  ...
  {
    name: "Email",
    href: "mailto:thukhaaung.dev@gmail.com",
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden className="h-5 w-5 fill-current">
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@thu.kha148",
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden className="h-5 w-5 fill-current">
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/thu-kha-aung-hishelloworld/",
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden className="h-5 w-5 fill-current">
